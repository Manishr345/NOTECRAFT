  ...
  const features = [
    {
      ...
      description:
        "Track and manage your notes issues with ease using our intuitive interface.",
    ...
    },
    {
      ...
      description:
        "Developed using new advanced frameworks for better efficiency.",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Watch our channel on YouTube",
      description:
        "Whether its you or Diddy, you can get to know about our product on YouTube",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Save your imaginations as words",
      description:
        "With our blazing fast, state of the art, cutting edge, we are so back cloud servies (read AWS) - you can write your notes.",
    ...
    (<div className="relative z-10 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p
          ...
          From note generation to note deletion, Everything we have features for
    ...
    (<a
      ...
      <div
        ...
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          ...
          <img
            src="https://media.npr.org/assets/img/2017/04/14/ap_142450164879-b920e832b9ce6d7983eef91197a233e7ed6304a6-s1200.jpg"
            alt="header"
            width={800}
            height={800}
...
export const SkeletonTwo = () => {
  const images = [
    "https://images.pexels.com/photos/4559555/pexels-photo-4559555.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    "https://images.pexels.com/photos/6016352/pexels-photo-6016352.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
